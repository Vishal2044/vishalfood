              ...
              <div class="row">
                  <div class="col">
                      <p>
                          ...
                          <span href="#">Add New Category</span>
                      </p>
                  </div>
              </div>
          </div>
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="ex : punjabi" name="category" required value="<?php echo $category?>" >
                    ...
                    <button type="submit" class="btn btn-primary mr-2 mt-4" name="submit" style="margin-left: 550px;">Submit</button>
                  </form>
                </div>
              </div>
            </div>
