    ...
    <div class="home-content">
            ...
            <div class="row">
                <div class="col m-2">
                    <p>
                        ...
                        &nbsp; &nbsp;&nbsp; &nbsp;
                        <a href="view_sales.php" class="btn btn-primary no-print position-relative">
                            <i class='bx bx-restaurant'></i>Food Sales
                        </a>
                        &nbsp; &nbsp;
                        <a href="bar_sales.php" class="btn btn-outline-danger no-print position-relative">
        ...
        <div class="sales-boxes">
            <div class="recent-sales box">
                <div class="title">Food Sales Information</div>
...
$sales = getAllSales($start_date, $end_date);
